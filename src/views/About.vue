<template>
    ...
    msg: {{ msg }}  <span class="material-icons md-18">circle</span>   apiHost:{{apiHost}}
    <button class="btn"><span class="material-icons md-24">face</span></button>

    <div class="mx-auto mt-8 prose prose-slate lg:prose-lg">
